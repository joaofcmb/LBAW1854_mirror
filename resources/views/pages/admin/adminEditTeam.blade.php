                ...
                <div class="card my-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            ...
                            <div class="profile card my-3">
                                <div class="card-body p-2">
                                    <a href="{{ route('profile', ['id' => $team->id_leader]) }}">
                                        <img src="{{ asset('img/profile.png') }}" width="50" height="50"
                                             class="d-inline-block rounded-circle align-self-center my-auto"
                                             alt="User photo">
                                        <span class="pl-4">{{ $team->leader->username }}</span>
                                    </a>
                                    <a href="" class="float-right pt-2 pr-2">
                                ...
                                <div class="profile card my-3">
                                    <div class="card-body p-2">
                                        <a href="{{ route('profile', ['id' => $member->id_user]) }}">
                                            <img src="{{ asset('img/profile.png') }}" width="50" height="50"
                                                 class="d-inline-block rounded-circle float-left my-auto"
                                                 alt="User photo">
                                            <span class="pt-2 pl-4 float-left main-tab">{{ $member->username }}</span>
                                        </a>
                                        <a id="leader-icon" href="#" class="float-right pt-2 pr-2">
                        ...
                        <div id="action-button" class="text-center">
                            <a href="" class="btn mt-3" role="button">Update</a>
                        </div>
                    </div>
                </div>
            </div>
